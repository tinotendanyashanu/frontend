            ...
            <div className="flex flex-col lg:flex-row gap-16 items-start">
                ...
                <div className="lg:w-2/3 grid gap-12">
                    ...
                    <div className="group">
                        ...
                        <p className="text-slate-600 text-lg leading-relaxed pl-14 border-l-2 border-slate-200 group-hover:border-blue-500 transition-colors duration-300">
                            We build production-ready applications with built-in authentication, payment infrastructure, and scalable data foundations — shipping in weeks, not quarters.
                        </p>
                    </div>
            ...
            <div className="space-y-24">
                ...
                <div className="flex flex-col lg:flex-row gap-12 lg:gap-24 items-center">
                    <div className="lg:w-1/2 order-2 lg:order-1">
                        ...
                        <p className="text-lg text-slate-600 mb-8 leading-relaxed">
                            We integrate intelligent search, conversational AI, and knowledge retrieval systems directly into your product — giving it a genuine competitive edge.
                        </p>
